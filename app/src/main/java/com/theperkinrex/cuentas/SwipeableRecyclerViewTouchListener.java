            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    if (rect.contains(x, y)) {
                        mDownView = child;
//                        mDownCard = child.findViewById(R.id.card);
                        break;
                    }
                }
...
//                    final View downCard = mDownCard; // mDownCard gets null'd before animation ends
                    final int downPosition = mDownPosition;
                    ++mDismissAnimationRefCount;
                    mAnimatingPosition = mDownPosition;
//                    Log.i("SWIPE", "P " + mViewWidth*1000 + "      V " + absVelocityX);
                    mAnimationTime = Math.min(mAnimationTime, (long) ((mViewWidth * 1000) / absVelocityX));
                    ViewCompat.animate(mDownView)
...
//                    dismissView.findViewById(R.id.RedBackground).setVisibility(View.INVISIBLE);
                    // Send a cancel event
